...
{
	// If AIMovement is added to a project via 'Add Feature' in the Unreal Editor the dependency on HeadMountedDisplay in AIMovement.Build.cs is not automatically propagated
